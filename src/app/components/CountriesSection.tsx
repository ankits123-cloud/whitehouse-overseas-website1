    ...
    <section className="py-20 bg-[#0f1c3f] relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-block bg-[#dc2626] px-4 py-2 rounded-full text-white text-sm mb-4" style={{ fontWeight: 600 }}>
            Global Reach
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl text-white mb-4" style={{ fontWeight: 700 }}>
            Countries We Deal In
          </h2>
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            We provide study abroad services for top destinations around the world
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-4 sm:gap-6">
          {countries.map((country, index) => (
            ...
            >
              ...
              <p className="text-white text-sm sm:text-base" style={{ fontWeight: 500 }}>
                {country.name}
              </p>
            </div>
          ))}
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          <div>
            <p className="text-4xl sm:text-5xl text-[#dc2626] mb-2" style={{ fontWeight: 700 }}>16+</p>
            <p className="text-white text-lg">Countries</p>
          </div>
          <div>
            <p className="text-4xl sm:text-5xl text-[#dc2626] mb-2" style={{ fontWeight: 700 }}>100+</p>
            <p className="text-white text-lg">Partner Universities</p>
          </div>
          <div>
            <p className="text-4xl sm:text-5xl text-[#dc2626] mb-2" style={{ fontWeight: 700 }}>50+</p>
